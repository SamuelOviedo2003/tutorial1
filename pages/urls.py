...
from .views import CartRemoveAllView, CartView, HomePageView,ContactPageView,AboutPageView, ImageViewFactory, ImageViewNoDI,ProductIndexView,ProductShowView,ProductCreateView
